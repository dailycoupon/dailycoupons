...
export const FAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Our 2xCashback program lets you earn double cashback on select purchases. Browse our cashback deals to start earning on your online shopping.',
  },
  {
    question: 'How often are new coupons added?',
    answer: 'We add and update coupons daily. Check back often to get the latest deals and promo codes.',
  },
  {
